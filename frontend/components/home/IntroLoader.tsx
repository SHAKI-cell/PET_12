...
const IntroLoader = () => {
  // Only show intro loader once per session — not on every Home navigation
  const [isVisible, setIsVisible] = useState(() => {
    if (typeof window !== "undefined") {
      return !sessionStorage.getItem("dofo_intro_shown");
    }
    return true;
  });
  ...
  useEffect(() => {
    ...
    // Mark as shown so it won't replay on navigation
    sessionStorage.setItem("dofo_intro_shown", "true");
